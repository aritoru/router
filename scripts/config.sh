...
# WiFi SSID to connect in client mode. Son los parámetros de conexión de la red WiFi a la que debe conectarse el dispositivo cuando está configurado en modo cliente.
